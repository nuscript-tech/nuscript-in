        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <span style={{ color: "#059669" }}>Transcription</span> for MTSOs.
            </motion.h1>
            ...
            <motion.p
              ...
              style={{ color: "#475569" }}
            >
              Stop managing headcounts and start managing outcomes. MedScribeAI is the high-performance dictation-to-report platform built exclusively for Indian MTSOs to serve the US healthcare market with <strong style={{ color: "#1E293B" }}>99%+ accuracy</strong> and <strong style={{ color: "#1E293B" }}>zero manual processing.</strong>
            </motion.p>
            ...
            >
              ...
              <a
                ...
                style={{ borderColor: "rgba(37,99,235,0.3)", color: "#059669", background: "transparent" }}
              >
