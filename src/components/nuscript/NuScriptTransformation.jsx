      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg lg:text-xl leading-relaxed font-medium" style={{ color: "#9CB2D8" }}>
            ...
            <span style={{ color: "#E8F1FF" }}>MedScribeAI turns your MTSO into a technology-led documentation powerhouse.</span>{" "}
          ...
          <div className="mt-10 grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.value} className="rounded-xl p-5 border" style={{ background: "rgba(6,13,26,0.6)", borderColor: "rgba(0,192,255,0.15)" }}>
                <p className="font-unbounded font-bold text-base mb-2" style={{ color: "#00C0FF" }}>{item.value}</p>
                <p className="text-sm" style={{ color: "#9CB2D8" }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </motion.div>
