...
export default function NuScriptWorkflow() {
  ...
  return (
    <section id="workflow" className="py-24 lg:py-32 border-t" style={{ borderColor: "rgba(11,218,81,0.1)" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div>
            <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6" style={{ background: "rgba(11,218,81,0.15)" }}>
              <Icon className="w-6 h-6" style={{ color: "#0BDA51" }} />
            </div>
            <h3 className="font-unbounded text-2xl font-bold mb-2" style={{ color: "#F1F5F9" }}>
              {pillar.title}
            </h3>
            <p className="text-sm font-medium mb-4" style={{ color: "#0BDA51" }}>{pillar.subtitle}</p>
