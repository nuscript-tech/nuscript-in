  ...
  return (
    <section className="py-24 lg:py-32">
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          {/* Ambient glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-px" style={{ background: "linear-gradient(90deg, transparent, #0099CC, transparent)" }} />

          <Quote className="w-8 h-8 mb-6 opacity-30" style={{ color: "#0099CC" }} />
          <p className="text-lg lg:text-xl leading-relaxed font-medium" style={{ color: "#CBD5E1" }}>
            ...
            <span style={{ color: "#0099CC" }}>compete with organized giants</span>{" "}
