    ...
    <section id="contact" className="py-24 lg:py-32" style={{ background: "rgba(11,218,81,0.03)" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          >
            Built to{" "}
            <span style={{ color: "#059669" }}>enterprise standard.</span>
          </motion.h2>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {specs.map((spec, index) => (
            <motion.div
              ...
              style={{ background: "rgba(11,218,81,0.04)", borderColor: "rgba(5,150,105,0.15)" }}
              onMouseEnter={e => {
            ...
            >
              ...
              <p className="font-unbounded text-base font-bold mb-3" style={{ color: "#1E293B" }}>{spec.value}</p>
              <p className="text-sm leading-relaxed" style={{ color: "#475569" }}>{spec.detail}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          ...
          <h3 className="font-unbounded text-2xl lg:text-3xl font-bold mb-4" style={{ color: "#0F172A" }}>
            Stop Losing Profit to Expiry & Stockouts.
          </h3>
          <p className="text-base mb-10 max-w-xl mx-auto" style={{ color: "#475569" }}>
