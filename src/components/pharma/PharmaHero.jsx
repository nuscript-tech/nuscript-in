    ...
    <section className="relative min-h-screen flex items-center overflow-hidden pt-16">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          style={{ background: "radial-gradient(circle, rgba(0,192,255,0.15) 0%, transparent 70%)" }}
        ...
        <div className="absolute inset-0 opacity-[0.04]" style={{
          backgroundImage: "linear-gradient(rgba(0,192,255,0.5) 1px, transparent 1px), linear-gradient(90deg, rgba(0,192,255,0.5) 1px, transparent 1px)",
          ...
          <div>
            ...
            >
              ...
              <a
                ...
                style={{ borderColor: "rgba(0,192,255,0.4)", color: "#6EE7B7", background: "transparent" }}
              >
                View Demo
              </a>
            </motion.div>
