...
export default function AboutOrigins() {
  return (
    <section id="origins" className="py-24 lg:py-32 border-t" style={{ borderColor: "rgba(0,191,255,0.1)" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            >
              25 Years of{" "}
              <span style={{ color: "#10B981" }}>Domain Mastery.</span>
            </motion.h2>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="relative">
            <div className="absolute left-5 top-0 bottom-0 w-px" style={{ background: "rgba(0,191,255,0.2)" }} />
