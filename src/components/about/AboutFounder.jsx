    ...
    <section className="py-24 lg:py-32 border-t" style={{ borderColor: "rgba(96,165,250,0.1)" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          style={{ background: "#F1F5F9", borderColor: "rgba(37,99,235,0.12)" }}
        >
          ...
          <div className="grid lg:grid-cols-3 gap-10 items-center">
            <div className="lg:col-span-2">
              <Quote className="w-8 h-8 mb-6 opacity-40" style={{ color: "#0284C7" }} />
              <p className="text-lg lg:text-xl leading-relaxed font-medium mb-8" style={{ color: "#334155" }}>
                ...
                <span style={{ color: "#0F172A" }}>'chassis'</span>{" "}
                for India's healthcare and financial infrastructure. We aren't just building apps; we are building the{" "}
                <span style={{ color: "#2563EB" }}>connective tissue for modern Indian enterprises.</span>"
              </p>
              <div>
                <p className="font-unbounded font-bold text-base" style={{ color: "#0F172A" }}>Arvind Manohar</p>
                <p className="text-sm mt-1" style={{ color: "#475569" }}>Founder & CEO, NuScript Technologies · 8 Startups · 4 Exits</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={stat.label} className="rounded-xl p-4 border text-center" style={{ background: "rgba(37,99,235,0.04)", borderColor: "rgba(37,99,235,0.08)" }}>
                  <p className="font-unbounded font-bold text-xl" style={{ color: "#0284C7" }}>{stat.value}</p>
