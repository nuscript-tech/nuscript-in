      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          Three principles. Zero{" "}
           <span style={{ color: "#2563EB" }}>compromise.</span>
        </motion.h2>
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-16">
          {values.map((v, i) => (
            <motion.div
              ...
              style={{ background: "rgba(37,99,235,0.04)", borderColor: "rgba(37,99,235,0.12)" }}
            >
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-5" style={{ background: "rgba(37,99,235,0.08)" }}>
                <v.icon className="w-6 h-6" style={{ color: "#0284C7" }} />
              </div>
              <h3 className="font-unbounded font-bold text-lg mb-3" style={{ color: "#0F172A" }}>{v.title}</h3>
              <p className="text-sm leading-relaxed" style={{ color: "#475569" }}>{v.detail}</p>
            </motion.div>
          ))}
        </div>
