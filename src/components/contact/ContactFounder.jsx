      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-xs font-medium tracking-widest uppercase mb-3" style={{ color: "#0EA5E9" }}>
                Founder's Direct
              </p>
            ...
            <div className="flex flex-col gap-4">
              <a
                ...
                style={{ background: "#0C1829", borderColor: "rgba(14,165,233,0.25)" }}
              >
                <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0" style={{ background: "rgba(14,165,233,0.15)" }}>
