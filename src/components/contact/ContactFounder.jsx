...
export default function ContactFounder() {
  return (
    <section className="py-16 lg:py-20 border-t" style={{ borderColor: "rgba(59,130,246,0.1)" }}>
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-xs font-medium tracking-widest uppercase mb-3" style={{ color: "#3B82F6" }}>
                Founder's Direct
              </p>
              ...
              <p className="text-sm leading-relaxed" style={{ color: "#94A3B8" }}>
                If you are a large-scale distributor or an MTSO processing over <strong style={{ color: "#E2E8F0" }}>1 million lines monthly</strong>, reach out directly to discuss enterprise-grade integration and custom workflows.
              </p>
            </div>
            <div className="flex flex-col gap-4">
              <a
                ...
                style={{ background: "#0C1829", borderColor: "rgba(59,130,246,0.25)" }}
              >
                ...
                <div>
                  <p className="text-xs font-semibold uppercase tracking-widest mb-0.5" style={{ color: "#3B82F6" }}>Founder's Office</p>
              ...
              <div className="px-6 py-4 rounded-xl" style={{ background: "rgba(59,130,246,0.06)", border: "1px solid rgba(59,130,246,0.12)" }}>
