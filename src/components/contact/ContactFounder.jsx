...
export default function ContactFounder() {
  return (
    <section className="py-16 lg:py-20 border-t" style={{ borderColor: "rgba(0,191,255,0.1)" }}>
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="px-6 py-4 rounded-xl" style={{ background: "rgba(0,191,255,0.06)", border: "1px solid rgba(0,191,255,0.12)" }}>
